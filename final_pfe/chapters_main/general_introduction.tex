...
\begin{enumerate}
  ...
  \item To integrate an AI-powered speech recognition engine (Whisper fine-tuned on Warsh recitation for the training pipeline; NVIDIA NeMo FastConformer in production) for real-time pronunciation analysis and Tajweed error detection.
