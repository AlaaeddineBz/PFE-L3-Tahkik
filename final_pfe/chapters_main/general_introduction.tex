...
\begin{enumerate}
  ...
  \item To integrate an AI-powered recitation analysis pipeline that combines three complementary models --- our own \texttt{tahkik-small-warsh} (Whisper-Small fine-tuned on Warsh recitation) for wrong-word and tashkeel detection, an NVIDIA NeMo FastConformer for transcription and CTC alignment, and the Muaalem model for per-letter Tajweed grading --- to deliver real-time pronunciation analysis and Tajweed error detection.
